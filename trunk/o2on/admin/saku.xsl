...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="keys">
      ...
      <div class="category">
        <form name="d" method="POST" action="/xml/saku">
          削除依頼
          <table width="100%">
            <tr>
              <th>URL</th>
            ...
            <tr>
              <th>タイトル</th>
              <td><input type="text" name="title" size="50" maxlength="32"/> ※空欄可</td>
            </tr>
            <tr>
              <th>理由</th>
      ...
      <div class="infomessage {info/message_type}">
    	...
    	<table width="100%">
      	<tr>
        	<th></th>
        	<th class="sort" onClick="Sort('date','text')">最終送信日時</th>
        	<th class="sort" onClick="Sort('title','text')">タイトル / 理由</th>
